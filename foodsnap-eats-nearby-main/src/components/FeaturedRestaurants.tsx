      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {restaurants.map((restaurant) => (
            ...
            >
              <div className="bg-white rounded-lg overflow-hidden shadow-md hover-scale card-shadow h-full">
                ...
                <div className="p-4">
                  ...
                  <div className="w-full text-center bg-white text-foodsnap-teal border border-foodsnap-teal hover:bg-foodsnap-teal hover:text-white transition-colors py-2 rounded-md font-medium">
                    View Menu
                  </div>
                </div>
              </div>
